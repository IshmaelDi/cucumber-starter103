Feature: H.E.L.P Family Cover
  ...
  Scenario Outline: User capture Family sale for lump sum cover of R5000 for age 12
    ...
    Examples:
      ...
      | idirero  | Ish@cyest#2003 | YF        | Family     | 2018-12-21 | Mr          | Shade      | Mills         | Yes               | 1811217503522 | 1811217503522 | Up to 3,000   | Sales and services | Matric    | 0601234231 | Plot 30 ward 55 | 1234       | Miss       | Joy       | McGregor     | 2211206805708 | 2211206805708  | Sister        | 1        | 01 Dec 2023 | CAPITEC BANK LTD | 470010     | Savings Account | 1234          | 1234           | 0601234230   | Yes             | 60201878       | Kzn Agriculture And Rural Development | Yes                 | Miss        | Hazel      | Smith         | Female       | 2011215719027 | Micheal   | Smith        | Male        | 1406030809188 | Yes            |
  ...
  Scenario Outline: User capture Family sale for lump sum cover of R5000 for age 20
    ...
    Examples:
      | Username | Password       | CoverPlan | PlanOption | MemberDOB    | MemberTitle | MemberName | MemberSurname | MemberCitizenShip | MemberID      | ConfirmID     | MonthlyIncome | Occupation         | Education | CellNumber | PostalAddress   | PostalCode | PayerTitle | PayerName | PayerSurname | PayerID       | ConfirmPayerID | PayerRelation | DebitDay | DebitDate   | BankName         | BranchCode | AccountType     | AccountNumber | ConfirmAccount | MobileNumber | IsPayerEmployee | EmployeeNumber | Department                   | DeductionAuthorized | SpouseTitle | SpouseName | SpouseSurname | SpouseGender | SpouseID      | ChildName | ChildSurname | ChildGender | ChildID       | IsChildStudent |
      | idirero  | Ish@cyest#2003 | YF        | Family     | 2014-06-2006 | Mr          | Shade      | Mills         | Yes               | 1406030809188 | 1406030809188 | Up to 3,000   | Sales and services | Matric    | 0601234231 | Plot 30 ward 55 | 1234       | Miss       | Joy       | McGregor     | 2211206805708 | 2211206805708  | Sister        | 1        | 01 Dec 2023 | CAPITEC BANK LTD | 470010     | Savings Account | 1234          | 1234           | 0601234230   | yes             | 60201878       | South African Police Service | Yes                 | Miss        | Hazel      | Smith         | Female       | 2011216395272 | Micheal   | Smith        | Male        | 1406030809188 | Yes            |
